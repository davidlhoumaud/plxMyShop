...
'L_ADMIN_MENU_TOOTIP'               => 'Gerir mon e-comerci (produits, categorias e comandas)',
'L_LANG_UNAVAILABLE'                => 'Lenga pas disponibla : %s',
...
'L_PRODUCTS_BASKET_BUTTON'          => 'Produit indisponible (boton "Ajustar al panièr" amagat)',
'L_PRODUCTS_ITEM_INSTOCK'           => 'Nombre de produits disponibles en resèrva (<b title="Lo darrièr comandat de la resèrva fa venir lo produit indisponible !'.PHP_EOL.'Lo boton d\'Ajustar al panièr es automaticament amagat ;-)'.PHP_EOL.'Desactivar son invisibilitat se la resèrva es estada voida puèi tornada emplenada.'.PHP_EOL.'(Se daissat void, lo sistèma de resèrva es inactiu)">opcional</b>)',# a traduire
'L_PRODUCTS_BASKET_NO_BUTTON'       => 'Messatge de replaçament del boton "Ajustar al panièr"',
...
'L_COMMAND_OF'                      => 'Comanda de',
'PAYPAL_ALT'                        => 'Commandar amb una CB',
...
#config page
'L_CONFIG_FOLDERS'                  => 'Emplaçament de las donadas <sup>(amb una barra oblica "/" a la fin)</sup>',
'L_CONFIG_ORDERS_FOLDER'            => 'Emplaçament del repertòri de las comandas',
'L_CONFIG_PRODUCTS_FOLDER'          => 'Emplaçament del repertòri dels produits',
'L_CONFIG_AFFICHER_PANIER_MENU'     => 'Afichar lo Panièr dins lo menú',
'L_CONFIG_AFFICHER_CATEGORIES_MENU' => 'Afichar las categorias dins lo menú',
'L_CONFIG_AFFICHER_LIEN_PANIER_TOP' => 'Afichar ligam Panièr \\_/ (produuits e categoria)',
...
'L_CONFIG_DELIVERY_DATE'            => 'Afichar la causida de la data e de l\'orari de liurason',
'L_CONFIG_DELIVERY_MINDAYS'         => 'Jorn e ora de la liurason',
...
'L_CONFIG_FREESHIPP'                => 'a partir de',
'L_FREESHIP'                        => 'Còstas de pòrts ofèrts',
...
'L_CONFIG_DELIVERY_PRICE'           => 'Prètz en ',
'L_CONFIG_NB_LINES'                 => '<b title="Nombre de linha de configuracion del tablèu de las còstas de pòrt. Salvagardar per far venir efectiu lo nombre de linhas, puèi modificatz e tornatz salvagardar">Nombre de linha</b>',
...
'L_CONFIG_MENU_TITLE'               => 'Configuracion del menú e tactica del cookie client',
'L_CONFIG_MENU_POSITION'            => 'Posicion dins lo menú de las categorias e paginas fixas (panièr)',
'L_CONFIG_SUBMENU'                  => 'Nom del sos-menú principal de la botiga (opcional)',
...
'L_CONFIG_LOCALSTORAGE'             => 'Activar l\'emmagazinatge local de las coordonadas client',
'L_CONFIG_COOKIE'                   => 'Servar 60 jorns per simplificar las comandas venentas',
#local storage
...
'L_EMAIL_WEIGHT'                    => 'Pes',
'L_EMAIL_DELIVERY_COST'             => 'Còstas de pòrt',
...
'L_EMAIL_SENT2'                     => 'Se lo corrièl de resumit de comanda apareis pas dins vòstra lista de corrièls en espèra o qu\'aqueste corrièl es indicat coma indesirable, mercés d\'ajustar %s a vòstra lista de contactes.',
...
'L_EMAIL_DELIVERYDATE'              => 'Data de liurason',
'L_EMAIL_DELIVERYTIME'              => 'Ora de liurason',
...
#Espace public
'L_PUBLIC_MSG_BASKET_UP'            => 'Vòstre panièr es actualizat',
...
'L_PUBLIC_MOD_BASKET'               => 'Modificar lo panièr',
'L_PUBLIC_DEL_BASKET'               => 'Levar del panièr',
'L_PUBLIC_BASKET_MINI_TITLE'        => 'Passar la comanda',
'L_PUBLIC_BASKET_MINI'              => 'Comandar !',
...
'L_CONFIG_VALIDATION_COMMANDE'      => "Validacion de la comanda",
...
'L_TOTAL_BASKET_PORT'               => ' (còstas de pòrt enclusa)',
'L_TITRE_PANIER'                    => 'Panièr',

#panier.php
'L_PRODUCT'                         => 'Produit',
'L_UNIT_PRICE'                      => 'Prètz unitari',
'L_NUMBER'                          => 'Nombre',
'L_TOTAL_PRICE'                     => 'Prètz total',
'L_PUBLIC_DELIVERYDATE'             => 'Seleccionatz vòstra data de liurason',
'L_PUBLIC_DELIVERYTIME'             => 'Séleccionatz vòstre interval de liurason',
'L_CHOICE_DELIVERYTIME'             => 'Causissètz vòstre interval orari',
'L_FORMAT_PIKADAY'                  => 'dddd Do MMMM YYYY',
'L_I18N_PIKADAY'                    => "
        i18n: {
            previousMonth : 'Mes precedent',
            nextMonth     : 'Mes seguent',
