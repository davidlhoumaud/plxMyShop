...
ob_start();
?>
 <p><img src="<?php echo $plxPlugin->plxMotor->racine . PLX_PLUGINS . $plxPlugin->plugName;?>/images/paypal_logo.gif" alt=""/></p>
 ...
 <p><img src="<?php echo $plxPlugin->plxMotor->racine . PLX_PLUGINS . $plxPlugin->plugName;?>/images/icon_load.gif" alt=""/></p>
